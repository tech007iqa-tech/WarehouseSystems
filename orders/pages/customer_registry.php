...
<!-- Import Modal -->
<div id="import-modal" class="modal-overlay" style="align-items: center; padding: 20px 10px;" onclick="closeImportModal()">
    <div class="profile-modal-box" onclick="event.stopPropagation()" style="max-width: 800px; width: 95%; margin: auto; max-height: calc(100vh - 40px); overflow-y: auto;">
        ...
        <div style="padding: 20px;">
            ...
            <textarea id="import-paste-area" placeholder="Paste rows here..." style="width: 100%; height: 120px; border-radius: 12px; border: 2px solid #e2e8f0; padding: 15px; font-family: monospace; font-size: 0.85rem; resize: vertical; margin-bottom: 20px; outline: none; transition: border-color 0.2s;" onfocus="this.style.borderColor='var(--accent-color)'" onblur="this.style.borderColor='#e2e8f0'"></textarea>
            ...
            <div id="import-preview" style="margin-bottom: 20px; display: none;">
                ...
                <div id="import-preview-scroll" style="max-height: 220px; overflow-y: auto; overflow-anchor: none; border: 1px solid #e2e8f0; border-radius: 12px; font-size: 0.7rem; background: #f8fafc;">
