...
<body class="safe-area-bottom">
    ...
    <header class="mobile-top-bar">
        ...
        <div style="font-weight: 800; color: var(--accent-color); font-size: 1.1rem; letter-spacing: -1px;">IQA METAL
        </div>
    ...
    <div class="app-container">
        ...
        <div id="printModal"
            style="display:none; position:fixed; inset:0; background:rgba(15, 23, 42, 0.7); z-index:2000; align-items:center; justify-content:center; padding:20px; backdrop-filter:blur(4px);">
            <div class="panel" style="width:100%; max-width:500px; box-shadow:0 25px 50px -12px rgba(0,0,0,0.5);">
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:15px; margin-bottom:25px;">
                    <!-- Label A Preview -->
                    <div id="prevLabelA"
                        style="border:2px solid var(--accent-color); border-radius:10px; padding:15px; text-align:center; background:var(--bg-page);">
                ...
                <label for="printQty"
                    style="display:block; margin-bottom:10px; font-weight:700; font-size:0.85rem;">Quantity of
                    Sets</label>
                ...
                <button id="confirmPrintBtn" class="btn btn-success"
                    style="width:100%; height:60px; font-size:1.1rem; gap:10px;">
    ...
    -->
        <aside class="sidebar">
            ...
            <label for="nav-toggle" class="mobile-only"
                style="position: absolute; top: 15px; right: 15px; font-size: 1.5rem; cursor: pointer; display: none;">✕</label>
            ...
            <nav style="flex: 1; overflow-y: auto;">
                <ul class="nav-menu">
                    <!-- PRIMARY NAV -->
                    <li
                        style="color: var(--text-secondary); font-size: 0.75rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; padding-left: 12px; margin-bottom: 8px;">
                        Workspace</li>
